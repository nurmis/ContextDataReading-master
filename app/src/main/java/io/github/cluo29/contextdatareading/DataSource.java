...
/**
 * Aggregates data {@link Source}s for all known concrete subclasses
 * of {@link AbstractEvent}. If your storage method changes, you probably
 * need to implement another subclass of this interface.
 */
public interface DataSource {
    ...
    interface Source<T extends AbstractEvent> {
        /**
         * @param device                         unique ID of the device from which the events originated.
         ...
         */
        List<T> apply(UUID device, int withIdGreaterThan, long withTimestampGreaterEqualTo, int number);
    }
